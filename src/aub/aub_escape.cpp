...
MJ_GAME_LIST_ADD(aub::aub_escape) // The class of the game is used here
...
/**
 * Constructor for an instance of an aub_escape
 * 
 ...
 */
aub_escape::aub_escape([[maybe_unused]] int completed_games, [[maybe_unused]] const mj::game_data& data) :
    mj::game("aub"),
    _player1(player({20, 0}, 2)),
    _player2(player({-20, 0}, 2))
    {}
 ...
 */
bn::string<16> aub_escape::title() const {
    return "Escape";
}
 ...
 */
int aub_escape::total_frames() const {
 ...
 */
mj::game_result aub_escape::play([[maybe_unused]] const mj::game_data& data)
{
 ...
 */
bool aub_escape::victory() const {
    return _player1.out_of_bounds() || _player2.out_of_bounds();
}
 ...
 * @param data shared information, such as a rng and number of frames left in the microgame
 */
void aub_escape::fade_in([[maybe_unused]] const mj::game_data& data)
{
}
 ...
 * @param data shared information, such as a rng and number of frames left in the microgame
 */
void aub_escape::fade_out([[maybe_unused]] const mj::game_data& data)
{
}
