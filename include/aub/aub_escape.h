#ifndef AUB_ESCAPE_H // Include guard must start with the 3-letter id
#define AUB_ESCAPE_H
 ...
 */
class aub_escape : public mj::game
{
    public:
        /**
         ...
         */
        aub_escape(int completed_games, const mj::game_data& data);
